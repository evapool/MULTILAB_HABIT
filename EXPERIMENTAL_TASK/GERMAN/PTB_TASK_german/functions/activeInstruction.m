...
%**************************************************************************
    ...
    function [] = Instructions_MP_7  (instrDisp, text, position, var)
       ...
       DrawFormattedText(var.w, buttonNextRepeatText, 'center', 'center', [0 0 0], 60);
       Screen('Flip',var.w);
        ...
        for ii = 1: length(squares)
            ...
            while ~correctPressed
                ...
                elseif (keyPressed == 1) && ~ismember(respKey, codeX)
                    ...
                    DrawFormattedText(var.w, [incorrectResponseText{1} '\n' '   ' num2str(buttonX) '   ' '\n' incorrectResponseText{2}], 'center', 'center', [200 0 0], 60, false, false, 1.2);
                    Screen('Flip',var.w);
                    WaitSecs(2);
                    correctPressed = 0;
        ...
        for ii = 1:length(condition)
            ...
            while ~correctPressed
                ...
                if (keyPressed == 1) && ismember(respKey, codeX) % correct
                    ...
                    DrawFormattedText(var.w, restRespondText{5}, 'center', var.yLowerLow, [0 120 0], 60); % explain text
                    Screen('Flip',var.w);
                ...
                elseif (keyPressed == 1) && ~ismember(respKey, codeX)
                    ...
                    DrawFormattedText(var.w, [restRespondText{6} conNameX restRespondText{7} '\n' restRespondText{8}], 'center', var.yLowerLow, [200 0 0], 60,false, false, 1.2); % explain text
                    Screen('Flip',var.w);
